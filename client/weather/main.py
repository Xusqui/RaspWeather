...
class Anemometer:
  ...
  def __init__(self):
    self._log = LOGGER_FACTORY.get_logger('weather.main')
    self._log.info(K.CLIENT_GREETING1)
    self._log.info(K.CLIENT_GREETING2)
    self._log.info(K.CLIENT_GREETING3)
    self._log.info(K.CLIENT_GREETING4)
    self._log.info(K.CLIENT_GREETING5)
