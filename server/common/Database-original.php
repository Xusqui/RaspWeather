...
class Database {
  ...
  public function dropTablesExceptConfig() {
    $this->query('DROP TABLE IF EXISTS temp, wind, hist, link, meta, door, pilots, temp_hum, adc, pressure, wind_dir, camera', 'rain');
  ...
  public function pruneTables($timestamp) {
    ...
    foreach (array('temp', 'link', 'meta', 'door', 'pilots', 'temp_hum', 'adc', 'pressure', 'wind_dir', 'camera', 'rain') as $table) {
